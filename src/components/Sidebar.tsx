...
const links = [
  ...
  { label: "Resume", href: "#", icon: HiOutlineDocumentText },
...
export default function Sidebar({ activePage, onNavigateHome }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col fixed top-0 left-0 w-[320px] h-screen h-dvh border-r border-border bg-background z-40">
        <div className="flex flex-col justify-between h-full px-10 py-14">
          <div>
            ...
            <div className="mt-8 min-h-[120px] overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.div
                  key={activePage}
          ...
          <div className="pt-8 border-t border-border">
            ...
            >
              ...
              >
                <span
                  className={`absolute top-[3px] left-[3px] w-4 h-4 rounded-full bg-background shadow-sm transition-transform duration-300 ${
                    gameMode ? "translate-x-[18px]" : "translate-x-0"
                  }`}
                />
              </span>
            </button>
